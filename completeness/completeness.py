...
def main(fitsfile, noisefile, b6fits, fluxfile_fits, ysocatalogfile, min_value_factor = 3, min_delta_factor = 1.5, min_npix = 15, dist=5.41*u.kpc, gridsize=100, band='b3'):
    ...
    if band =='b6':
        freq = cen_freq(header['CRVAL4'],header['CDELT4'])
    else:
        freq = cen_freq(header['CRVAL3'],header['CDELT4'])
    ...
    YSO_xypos = np.vstack((ysocatalog['%s_xpix'%band], ysocatalog['%s_ypix'%band])).T
    #print(YSO_xypos.shape)

    ysoind = np.where(ysocatalog['%s_xpix']%band>0)[0]
    #print('ysoind',ysoind)
    ...
    return np.vstack((completeness_arr, fluxarr.value)).T


w51e_completeness = main(w51e_b3_tt0, w51e_b3_noise, w51e_b6_calibrated_pbcor, w51e_b3_flux, w51e_matched_catalog)
w51n_completeness = main(w51n_b3_tt0, w51n_b3_noise, w51n_b6_calibrated_pbcor, w51n_b3_flux, w51n_matched_catalog, dist=5.1*u.kpc)

np.savetxt('w51e_b3_completeness.txt',w51e_completeness, newline='\n', delimiter=' ')
np.savetxt('w51n_b3_completeness.txt',w51n_completeness, newline='\n', delimiter=' ')


w51e_completeness = main(w51e_b6_calibrated_pbcor, w51e_b6_noise, w51e_b6_calibrated_pbcor, w51e_b6_flux, w51e_matched_catalog, band='b6')
w51n_completeness = main(w51n_b6_calibrated_pbcor, w51n_b6_noise, w51n_b6_calibrated_pbcor, w51n_b6_flux, w51n_matched_catalog, dist=5.1*u.kpc, band='b6')

np.savetxt('w51e_b6_completeness.txt',w51e_completeness, newline='\n', delimiter=' ')
np.savetxt('w51n_b6_completeness.txt',w51n_completeness, newline='\n', delimiter=' ')
